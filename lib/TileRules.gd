...
const TileRule = {
	TileTypes.DWARF : {
		"UP" : [TileTypes.DWARF, TileTypes.UEWALL, TileTypes.WALL, TileTypes.ULWALL, TileTypes.URWALL],
		"DOWN" : [TileTypes.DWARF, TileTypes.BEWALL, TileTypes.WALL, TileTypes.BLWALL, TileTypes.BRWALL],
		...
		"UL" : [TileTypes.DWARF, TileTypes.WALL, TileTypes.LEWALL, TileTypes.UEWALL, TileTypes.ULWALL],
		"UR" : [TileTypes.DWARF, TileTypes.WALL, TileTypes.REWALL, TileTypes.UEWALL, TileTypes.URWALL],
		"BL" : [TileTypes.DWARF, TileTypes.WALL, TileTypes.LEWALL, TileTypes.BEWALL, TileTypes.BLWALL],
		"BR" : [TileTypes.DWARF, TileTypes.WALL, TileTypes.REWALL, TileTypes.BEWALL, TileTypes.BRWALL],
	},
	TileTypes.FLOOR : {
		"UP" : [TileTypes.DWARF, TileTypes.UEWALL, TileTypes.WALL, TileTypes.ULWALL, TileTypes.URWALL],
		"DOWN" : [TileTypes.DWARF, TileTypes.BEWALL, TileTypes.WALL, TileTypes.BLWALL, TileTypes.BRWALL],
	...
	TileTypes.WALL : {
		"UP" : [TileTypes.DWARF, TileTypes.FLOOR, TileTypes.ULWALL, TileTypes.URWALL, TileTypes.BRWALL, TileTypes.BLWALL, TileTypes.REWALL, TileTypes.LEWALL, TileTypes.BEWALL],
		"DOWN" : [TileTypes.DWARF, TileTypes.FLOOR, TileTypes.ULWALL, TileTypes.URWALL, TileTypes.BRWALL, TileTypes.BLWALL, TileTypes.REWALL, TileTypes.LEWALL, TileTypes.UEWALL],
		"RIGHT" : [TileTypes.DWARF, TileTypes.FLOOR, TileTypes.ULWALL, TileTypes.URWALL, TileTypes.BRWALL, TileTypes.BLWALL, TileTypes.BEWALL, TileTypes.LEWALL, TileTypes.UEWALL],
		"LEFT" : [TileTypes.DWARF, TileTypes.FLOOR, TileTypes.ULWALL, TileTypes.URWALL, TileTypes.BRWALL, TileTypes.BLWALL, TileTypes.BEWALL, TileTypes.REWALL, TileTypes.UEWALL],
		"UL" : [TileTypes.DWARF, TileTypes.FLOOR, TileTypes.BLWALL, TileTypes.URWALL, TileTypes.BRWALL, TileTypes.BEWALL, TileTypes.REWALL],
		"UR" : [TileTypes.DWARF, TileTypes.FLOOR, TileTypes.BLWALL, TileTypes.ULWALL, TileTypes.BRWALL, TileTypes.BEWALL, TileTypes.LEWALL],
		"BL" : [TileTypes.DWARF, TileTypes.FLOOR, TileTypes.URWALL, TileTypes.ULWALL, TileTypes.BRWALL, TileTypes.UEWALL, TileTypes.REWALL],
		"BR" : [TileTypes.DWARF, TileTypes.FLOOR, TileTypes.URWALL, TileTypes.ULWALL, TileTypes.BLWALL, TileTypes.UEWALL, TileTypes.LEWALL],
	},
	TileTypes.ULWALL : {
		...
		"DOWN" : [TileTypes.DWARF, TileTypes.FLOOR, TileTypes.WALL, TileTypes.ULWALL, TileTypes.URWALL, TileTypes.BRWALL, TileTypes.BEWALL, TileTypes.REWALL, TileTypes.UEWALL],
		"RIGHT" : [TileTypes.DWARF, TileTypes.FLOOR, TileTypes.WALL, TileTypes.ULWALL, TileTypes.BLWALL, TileTypes.BRWALL, TileTypes.BEWALL, TileTypes.LEWALL, TileTypes.REWALL],
	...
	TileTypes.URWALL : {
		"UP" : [TileTypes.WALL, TileTypes.ULWALL, TileTypes.BLWALL, TileTypes.URWALL, TileTypes.BRWALL, TileTypes.BEWALL, TileTypes.LEWALL, TileTypes.REWALL, TileTypes.UEWALL],
		"DOWN" : [TileTypes.DWARF, TileTypes.FLOOR, TileTypes.WALL, TileTypes.ULWALL, TileTypes.BLWALL, TileTypes.URWALL, TileTypes.BEWALL, TileTypes.LEWALL, TileTypes.UEWALL],
		...
		"LEFT" : [TileTypes.DWARF, TileTypes.FLOOR, TileTypes.WALL, TileTypes.BLWALL, TileTypes.URWALL, TileTypes.BRWALL, TileTypes.BEWALL, TileTypes.LEWALL, TileTypes.REWALL],
	...
	TileTypes.BLWALL : {
		"UP" : [TileTypes.DWARF, TileTypes.FLOOR, TileTypes.WALL, TileTypes.BLWALL, TileTypes.URWALL, TileTypes.BRWALL, TileTypes.BEWALL, TileTypes.REWALL, TileTypes.UEWALL],
		...
		"RIGHT" : [TileTypes.DWARF, TileTypes.FLOOR, TileTypes.WALL, TileTypes.ULWALL, TileTypes.BLWALL, TileTypes.URWALL, TileTypes.LEWALL, TileTypes.REWALL, TileTypes.UEWALL],
		"LEFT" : [TileTypes.WALL, TileTypes.ULWALL, TileTypes.BLWALL, TileTypes.URWALL, TileTypes.BRWALL, TileTypes.BEWALL, TileTypes.LEWALL, TileTypes.REWALL, TileTypes.UEWALL],
	...
	TileTypes.BRWALL: {
		"UP" : [TileTypes.DWARF, TileTypes.FLOOR, TileTypes.WALL, TileTypes.ULWALL, TileTypes.BLWALL, TileTypes.BRWALL, TileTypes.BEWALL, TileTypes.LEWALL, TileTypes.UEWALL],
		"DOWN" : [TileTypes.WALL, TileTypes.ULWALL, TileTypes.BLWALL, TileTypes.URWALL, TileTypes.BRWALL, TileTypes.BEWALL, TileTypes.LEWALL, TileTypes.REWALL, TileTypes.UEWALL],
		"RIGHT" : [TileTypes.WALL, TileTypes.ULWALL, TileTypes.BLWALL, TileTypes.URWALL, TileTypes.BRWALL, TileTypes.BEWALL, TileTypes.LEWALL, TileTypes.REWALL, TileTypes.UEWALL],
		"LEFT" : [TileTypes.DWARF, TileTypes.FLOOR, TileTypes.WALL, TileTypes.ULWALL, TileTypes.URWALL, TileTypes.BRWALL, TileTypes.LEWALL, TileTypes.REWALL, TileTypes.UEWALL],
		"UL" : [TileTypes.DWARF, TileTypes.FLOOR, TileTypes.BLWALL, TileTypes.URWALL, TileTypes.BRWALL, TileTypes.BEWALL, TileTypes.REWALL],
